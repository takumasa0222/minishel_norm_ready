...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   extend_str_functions.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: tamatsuu <tamatsuu@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/01/13 20:11:17 by tamatsuu          #+#    #+#             */
/*   Updated: 2025/01/13 20:19:53 by tamatsuu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static size_t	l_check(size_t len, size_t s_len, unsigned int st, char *s);
...
char	*x_substr(char const *s, unsigned int start, size_t len)
{
	...
	if (!s || len > SIZE_MAX)
		return (NULL);
	str_len = ft_strlen(s);
	len = l_check(len, str_len, start, (char *)s);
