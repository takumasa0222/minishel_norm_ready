...
/*   Updated: 2024/11/19 20:37:11 by ssoeno           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
TestCase		test_cases[] = {
	...
	{"pwd", 1, {"pwd", NULL}, "pwd after cd ../../, expect home"},
	{"cd", 2, {"cd", "Downloads", NULL}, "cd Downloads"},
	{"pwd", 1, {"pwd", NULL}, "pwd after cd Downloads"},
	{"cd", 2, {"cd", "../../", NULL}, "cd ../../, expect home"},
	{"pwd", 1, {"pwd", NULL}, "pwd after cd ../../, expect home"},
	{"cd", 2, {"cd", "-", NULL}, "Change to the previous directory (cd -)"},
	{"pwd", 1, {"pwd", NULL}, "pwd after failed cd -, expect home"},
	// {"cd", 2, {"cd", "-", NULL}, "repeat cd -) "}, // cd - is not implemented yet
	// {"pwd", 1, {"pwd", NULL}, "pwd after repeated cd - "}
	...
	{"pwd", 1, {"pwd", NULL}, "pwd after cd ., expect /tmp"},
	...
	{"cd", 2, {"cd", "/tmp", NULL}, "Change to the specified directory /tmp"},
	{"pwd", 1, {"pwd", NULL}, "pwd after cd /tmp"},
    {"cd", 2, {"cd", "/nonexistentdir", NULL}, "cd to a non-existent directory"},
	{"pwd", 1, {"pwd", NULL}, "pwd after failed cd to a non-existent directory (expect /tmp)"},
    {"cd", 3, {"cd", "extra_arg", NULL}, "Too many arguments for cd"},
